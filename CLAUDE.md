...
| `src/harness/rules-loader.ts` | <!-- gen:builtin_rule_count -->120<!-- /gen:builtin_rule_count --> built-in rules + JSON config + hot-reload |
...
| File | Contents |
|------|----------|
| `docs/generated/guard-rules.md` | All <!-- gen:builtin_rule_count -->120<!-- /gen:builtin_rule_count --> built-in guard rules by category |
