...
| `src/harness/checks/__tests__/rollback-feasibility.integration.test.ts` | NEW — covers untracked/tracked/staged combinations + adversarial filenames (e.g. `--all`, files with spaces/newlines) to confirm argv path is shell-injection-safe |
