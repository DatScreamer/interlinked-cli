// ===========================================
// UBS (universal-bug-signature) sections
// ===========================================
// Fragment of the declarative section table in `./section-table.ts`.
// Covers UBS Plan 04 (rows 22–30), the Plan 04 D.1 backlog, and the
// Plan 04 D.2 pattern-parity expansion. Composed — in order — by
// `./section-table.ts`.

import type { SectionSpec } from "./section-table-types.js";

/** UBS Plan 04 + D.1 backlog + D.2 pattern-parity sections. */
export const ubsSections: readonly SectionSpec[] = [
