...
export const CODE_QUALITY_ENTRIES: CheckRegistration[] = [
	...
	},
	{
		...
		description:
			"`if (!X_AVAILABLE) return;` inside a test records a PASS wherever the external dependency is missing — CI reports green while running nothing, hiding the gap until an unguarded sibling fails",
		tier: 1,
		determinism: "fully_deterministic",
		severity: "warning",
		pipeline: "agent_safety",
