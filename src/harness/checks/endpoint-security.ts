...
function collectWhereClauses(body: string): string[] {
...
function referencesExemptTable(body: string, exemptTables: Set<string>): boolean {
...
function queryIsDynamic(body: string): boolean {
