...
function provenanceExtras(v: Record<string, unknown>): ProvenanceExtras | null {
...
function requiredCore(v: Record<string, unknown>): RequiredCore | null {
...
function parseArrayFields(value: Record<string, unknown>): ArrayFields | null {
...
function parseCheckField(value: Record<string, unknown>): { check: string | null } | null {
	const { check } = value;
 ...
 *  out to keep `parseFinding` under the cyclomatic cap. */
function parseOptionalScalars(value: Record<string, unknown>): OptionalScalars | null {
